...
class ImageCropperComponent {
    ...
    ngAfterViewInit() {
        var _a;
        (_a = this.newSwiper) === null || _a === void 0 ? void 0 : _a.swiperRef;
    }
    ngOnChanges(changes) {
        var _a;
...
ImageCropperModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: ImageCropperModule, declarations: [ImageCropperComponent], imports: [CommonModule,
        SwiperModule], exports: [ImageCropperComponent] });
...
//# sourceMappingURL=ngx-image-zoom-cropper.mjs.map
